...
export default function Pedidos() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Modal confirmar eliminação de pedido */}
      {confirmDelete && (
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
        ...
        <button onClick={abrirModal} style={{ background: '#2563EB', color: '#fff', border: 'none', borderRadius: 8, padding: '10px 18px', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>
          + Novo Pedido
        </button>
      </div>
